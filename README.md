...
- [kadalu/kadalu](https://github.com/kadalu/kadalu) (★727 Python) - Kadalu is a lightweight persistent storage solution for Kubernetes, OpenShift, and Nomad utilizing GlusterFS.
- [mr-karan/homelab](https://github.com/mr-karan/homelab) (★266 HTML) - This project provides infrastructure as code and setup scripts for a personal home server using Nomad.
...
- [hashicorp/damon](https://github.com/hashicorp/damon) (★443 Go) - Damon is a terminal dashboard for effectively interacting with HashiCorp Nomad.
...
- [robinovitch61/wander](https://github.com/robinovitch61/wander) (★459 Go) - Wander is a terminal application designed to interact with HashiCorp Nomad clusters.
...
- [dokku/dokku](https://github.com/dokku/dokku) (★30302 Shell) - Dokku is a Docker-powered platform-as-a-service that simplifies the process of building and managing app lifecycles.
...
- [star3am/hashiqube](https://github.com/star3am/hashiqube) (★114 JavaScript) - HashiQube is a DevOps development lab for running all HashiCorp products in Docker or Vagrant.
...
- [crazy-max/diun](https://github.com/crazy-max/diun) (★3506 Go) - Diun is a CLI application that notifies users when a Docker image is updated on a registry.


## Plugins

- [Roblox/nomad-driver-containerd](https://github.com/Roblox/nomad-driver-containerd) (★225 Go) - This project is a Nomad task driver that enables the launching of containers using containerd directly.
