...
- [jippi/awesome-nomad](https://github.com/jippi/awesome-nomad) (★888 ) - A curated list of tools, plugins, utilities, and resources for enhancing and managing HashiCorp Nomad deployments and workflows.
...
- [star3am/hashiqube](https://github.com/star3am/hashiqube) (★116 JavaScript) - HashiQube is an all-in-one hands-on DevOps lab that runs all HashiCorp products including Nomad, providing a versatile environment for learning, practicing, and demonstrating infrastructure and security tools in cloud or local setups.
...
- [thangchung/go-coffeeshop](https://github.com/thangchung/go-coffeeshop) (★4235 Go) - go-coffeeshop is an event-driven microservices demo application built with Golang, deployed using HashiCorp Nomad, Consul Connect, Vault, and Terraform, demonstrating modern microservices architecture and deployment practices.
...
- [astro/skyflake](https://github.com/astro/skyflake) (★221 Nix) - Skyflake is a NixOS-based hyperconverged infrastructure solution that uses HashiCorp Nomad to manage dynamic virtual machines, enabling GitOps-style deployments and cluster management.
...
- [cosmonic-labs/netreap](https://github.com/cosmonic-labs/netreap) (★137 Go) - Netreap is a Cilium controller designed to manage Cilium networking and policies within Nomad clusters, providing Kubernetes-independent cluster management and policy synchronization.
...
- [nomad-ops/nomad-ops](https://github.com/nomad-ops/nomad-ops) (★82 TypeScript) - Nomad-Ops is a GitOps operator for HashiCorp Nomad that reconciles running jobs with Git repositories to automate and simplify Nomad job management.
...
- [jsiebens/hashi-up](https://github.com/jsiebens/hashi-up) (★688 Go) - hashi-up is a lightweight utility that automates the installation and clustering of HashiCorp Consul, Nomad, or Vault on remote Linux hosts over SSH in under one minute.
- [kencx/homelab](https://github.com/kencx/homelab) (★162 YAML) - kencx/homelab is an infrastructure-as-code project for automated deployment and management of a HashiCorp Nomad, Consul, and Vault cluster on Proxmox using Packer, Terraform, and Ansible.
...
- [zerodha/nomad-cluster-setup](https://github.com/zerodha/nomad-cluster-setup) (★151 HCL) - Terraform modules and Packer scripts to deploy and manage scalable HashiCorp Nomad clusters on AWS using Auto Scaling Groups, custom AMIs, and optional load balancing.
...
- [kadalu/kadalu](https://github.com/kadalu/kadalu) (★728 Python) - Kadalu is a lightweight persistent storage solution for container orchestration platforms like Kubernetes, OpenShift, and Nomad, using GlusterFS to provide scalable and reliable storage services.
...
- [mr-karan/nomad-monitoring](https://github.com/mr-karan/nomad-monitoring) (★60 HCL) - A collection of jobspecs and Grafana dashboards for comprehensive end-to-end monitoring of HashiCorp Nomad clusters, utilizing Prometheus metrics and VictoriaMetrics for efficient data collection and storage.
...
- [robinovitch61/wander](https://github.com/robinovitch61/wander) (★456 Go) - Wander is a terminal-based TUI application for efficiently managing and monitoring HashiCorp Nomad clusters with features like live log tailing, event monitoring, and administrative controls.
...
- [Roblox/nomad-driver-containerd](https://github.com/Roblox/nomad-driver-containerd) (★227 Go) - Nomad-driver-containerd is a Nomad task driver that enables launching containers directly using containerd, providing a Docker-free container orchestration solution within Nomad.
...
- [cneira/firecracker-task-driver](https://github.com/cneira/firecracker-task-driver) (★149 Go) - A Nomad task driver that enables the creation and management of Firecracker micro-virtual machines within the Nomad orchestration platform.
...
- [hashicorp/nomad-driver-podman](https://github.com/hashicorp/nomad-driver-podman) (★241 Go) - A Nomad task driver plugin that enables sandboxing and management of workloads in Podman containers with advanced resource and network configuration features.
