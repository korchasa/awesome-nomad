...
- [jippi/awesome-nomad](https://github.com/jippi/awesome-nomad) (★892 ) - A curated list of tools, plugins, utilities, and resources for enhancing and managing HashiCorp Nomad deployments and workflows.
- [thangchung/coffeeshop-modular](https://github.com/thangchung/coffeeshop-modular) (★49 C#) - .NET coffee shop application with a modular architecture, containerized and deployable using HashiCorp Nomad.


## Demo and Learning Resources

- [fhemberger/nomad-demo](https://github.com/fhemberger/nomad-demo) (★132 HCL) - A Vagrant-based demo environment for running and exploring HashiCorp Nomad, Consul, and Vault with integrated service discovery, workload orchestration, and monitoring tools.
- [nairnavin/practical-nomad-consul](https://github.com/nairnavin/practical-nomad-consul) (★60 HCL) - A practical tutorial and guide for deploying a realistic multi-tier Spring Boot Petclinic application using HashiCorp Nomad and Consul with service mesh, ingress and terminating gateways, load balancing, and secure communication.
- [star3am/hashiqube](https://github.com/star3am/hashiqube) (★125 JavaScript) - HashiQube is an all-in-one hands-on DevOps lab that runs all HashiCorp products including Nomad, providing a versatile environment for learning, practicing, and demonstrating infrastructure and security tools in cloud or local setups.
...
- [thangchung/go-coffeeshop](https://github.com/thangchung/go-coffeeshop) (★4271 Go) - go-coffeeshop is an event-driven microservices demo application built with Golang, deployed using HashiCorp Nomad, Consul Connect, Vault, and Terraform, demonstrating modern microservices architecture and deployment practices.
...
- [astro/skyflake](https://github.com/astro/skyflake) (★223 Nix) - Skyflake is a NixOS-based hyperconverged infrastructure solution that uses HashiCorp Nomad to manage dynamic virtual machines, enabling GitOps-style deployments and cluster management.
...
- [kocierik/mcp-nomad](https://github.com/kocierik/mcp-nomad) (★34 Go) - mcp-nomad is a Golang-based MCP server that connects to HashiCorp Nomad, providing comprehensive management of Nomad jobs, deployments, nodes, ACLs, and other cluster resources through the Model Context Protocol.
...
- [ngine-io/chaotic](https://github.com/ngine-io/chaotic) (★71 Python) - Chaotic is a chaos engineering tool for cloud environments with advanced support for HashiCorp Nomad, enabling controlled failure simulations to test infrastructure resilience.
...
- [jsiebens/hashi-up](https://github.com/jsiebens/hashi-up) (★692 Go) - hashi-up is a lightweight utility that automates the installation and clustering of HashiCorp Consul, Nomad, or Vault on remote Linux hosts over SSH in under one minute.
- [kencx/homelab](https://github.com/kencx/homelab) (★179 YAML) - kencx/homelab is an infrastructure-as-code project for automated deployment and management of a HashiCorp Nomad, Consul, and Vault cluster on Proxmox using Packer, Terraform, and Ansible.
...
- [zerodha/nomad-cluster-setup](https://github.com/zerodha/nomad-cluster-setup) (★156 HCL) - Terraform modules and Packer scripts to deploy and manage scalable HashiCorp Nomad clusters on AWS using Auto Scaling Groups, custom AMIs, and optional load balancing.
...
- [kadalu/kadalu](https://github.com/kadalu/kadalu) (★732 Python) - Kadalu is a lightweight persistent storage solution for container orchestration platforms like Kubernetes, OpenShift, and Nomad, using GlusterFS to provide scalable and reliable storage services.
...
- [hashicorp/damon](https://github.com/hashicorp/damon) (★453 Go) - Damon is a terminal user interface (TUI) that provides an interactive dashboard for managing and monitoring HashiCorp Nomad resources such as Jobs, Deployments, and Allocations.
...
- [Roblox/nomad-driver-containerd](https://github.com/Roblox/nomad-driver-containerd) (★229 Go) - Nomad-driver-containerd is a Nomad task driver that enables launching containers directly using containerd, providing a Docker-free container orchestration solution within Nomad.
...
- [cneira/firecracker-task-driver](https://github.com/cneira/firecracker-task-driver) (★155 Go) - A Nomad task driver that enables the creation and management of Firecracker micro-virtual machines within the Nomad orchestration platform.
